...
def extract(cover, key):
	...
	video_txt_location = 'outfile.' + indexData[0]
	video_location = 'extractedVideo.' + indexData[1]

	f = open(video_txt_location, 'w')
	...
	with open(video_txt_location,"rb") as res:
		str = base64.b64decode(res.read())
	fh = open(video_location, "wb")
	fh.write(str)
	fh.close()
	os.remove(video_txt_location)
